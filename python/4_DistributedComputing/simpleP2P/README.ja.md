# simpleP2P (Python) - Japanese Learning Guide
...
Original README headings: `Sample: simpleP2P (Python)`, `Description`, `What you will learn`, `Key libraries`, `Key APIs`, `Peer-to-Peer (P2P): When to Use`, `Benefits`, `Requirements`

> **日本語**
> `python/4_DistributedComputing/simpleP2P` は `4_DistributedComputing` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `simpleP2P (Python)` and should be read together with the original README and source files.
