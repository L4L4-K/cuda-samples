# multiGPUGradientAverage (Python) - Japanese Learning Guide
...
Original README headings: `Sample: multiGPUGradientAverage (Python)`, `Description`, `What you will learn`, `Prerequisites`, `Installation`, `Running`, `Single node (2 GPUs)`, `Single node (4 GPUs)`

> **日本語**
> `python/4_DistributedComputing/multiGPUGradientAverage` は `4_DistributedComputing` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `multiGPUGradientAverage (Python)` and should be read together with the original README and source files.
