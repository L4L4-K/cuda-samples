# TensorFlow Custom GPU Operator - Japanese Learning Guide
...
Original README headings: `Sample: TensorFlow Custom GPU Operator`, `Description`, `Key Question Answered`, `Requirements`, `Installation`, `How to Run`, `Usage Example`, `Simple usage`

> **日本語**
> `python/3_FrameworkInterop/customTensorFlowKernel` は `3_FrameworkInterop` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `TensorFlow Custom GPU Operator` and should be read together with the original README and source files.
