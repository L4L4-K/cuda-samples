# PyTorch Custom GPU Operator - Japanese Learning Guide
...
Original README headings: `Sample: PyTorch Custom GPU Operator`, `Description`, `Requirements`, `Installation`, `How to Run`, `Basic usage`, `Test with more elements`, `Use specific GPU`

> **日本語**
> `python/3_FrameworkInterop/customPyTorchKernel` は `3_FrameworkInterop` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `PyTorch Custom GPU Operator` and should be read together with the original README and source files.
