# Numpy vs. Cupy (Python) - Japanese Learning Guide
...
Original README headings: `Sample: Numpy vs. Cupy (Python)`, `Description`, `What you will learn`, `Key libraries`, `Key APIs`, `Requirements`, `How to run`, `Pre-steps:`

> **日本語**
> `python/1_GettingStarted/numpyVsCupy` は `1_GettingStarted` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `Numpy vs. Cupy (Python)` and should be read together with the original README and source files.
