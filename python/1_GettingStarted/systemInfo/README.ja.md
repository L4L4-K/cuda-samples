# System Information Query (Python) - Japanese Learning Guide
...
English anchor: this sample demonstrates `System Information Query (Python)` and should be read together with the original README and source files.
