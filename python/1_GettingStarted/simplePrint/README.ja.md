...
Original README headings: `simplePrint - Printing from CUDA Kernels`, `Description`, `Key Concepts`, `CUDA APIs involved`, `[cuda.core (cuda-python)](https://nvidia.github.io/cuda-python/)`, `[Numba CUDA](https://nvidia.github.io/numba-cuda/)`, `CUDA Kernel Functions`, `What You Learn`

> **日本語**
> `python/1_GettingStarted/simplePrint` は `1_GettingStarted` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `simplePrint - Printing from CUDA Kernels` and should be read together with the original README and source files.
