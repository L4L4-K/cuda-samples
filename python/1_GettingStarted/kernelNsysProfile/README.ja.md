# Kernel Nsys Profiling - CUDA C++ Kernel Profiling with cuda.core (Python) - Japanese Learning Guide
...
> **日本語**
> `python/1_GettingStarted/kernelNsysProfile` は `1_GettingStarted` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `Kernel Nsys Profiling - CUDA C++ Kernel Profiling with cuda.core (Python)` and should be read together with the original README and source files.
