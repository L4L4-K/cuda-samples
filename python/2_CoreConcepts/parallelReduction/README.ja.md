# Parallel Reduction (Python) - Japanese Learning Guide
...
Original README headings: `Sample: Parallel Reduction (Python)`, `Description`, `What You'll Learn`, `Key Concepts`, `Reduction Tree Pattern`, `Avoiding Warp Divergence`, `Requirements`, `Hardware`

> **日本語**
> `python/2_CoreConcepts/parallelReduction` は `2_CoreConcepts` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `Parallel Reduction (Python)` and should be read together with the original README and source files.
