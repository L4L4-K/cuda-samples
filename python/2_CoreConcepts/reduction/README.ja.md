# Fast Array Sum using Shared Memory (Python) - Japanese Learning Guide
...
Original README headings: `Sample: Fast Array Sum using Shared Memory (Python)`, `Description`, `What you will learn`, `Key libraries`, `Key APIs (quick reference)`, `Requirements`, `How to run`, `Output`

> **日本語**
> `python/2_CoreConcepts/reduction` は `2_CoreConcepts` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `Fast Array Sum using Shared Memory (Python)` and should be read together with the original README and source files.
