# simpleZeroCopy (Python) - Japanese Learning Guide
...
Original README headings: `Sample: simpleZeroCopy (Python)`, `Description`, `What you will learn`, `Key libraries`, `Key APIs`, `Zero-Copy Memory: When to Use`, `Benefits`, `Limitations`

> **日本語**
> `python/2_CoreConcepts/simpleZeroCopy` は `2_CoreConcepts` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `simpleZeroCopy (Python)` and should be read together with the original README and source files.
