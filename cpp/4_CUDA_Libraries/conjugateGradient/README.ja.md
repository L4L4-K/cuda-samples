# conjugateGradient - ConjugateGradient - Japanese Learning Guide
...
English anchor: read `conjugateGradient` as a focused example of the CUDA concepts used in `cpp/4_CUDA_Libraries/conjugateGradient`.
> **日本語**
> この sample の目的は、`conjugateGradient` の小さな実装を通して CUDA Libraries, Shared Memory, Memory, Execution Model, Debugging, Profiling, And Testing を具体的に追うことです。
>
> **学習メモ**
...
```bash
cmake -S . -B build
cmake --build build --target conjugateGradient
ctest --test-dir build -R conjugateGradient
```
