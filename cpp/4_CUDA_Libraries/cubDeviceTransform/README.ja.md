...
Original README headings: `cubDeviceTransform - CUB DeviceTransform N-to-M`, `Description`, `Key Concepts`, `Supported SM Architectures`, `Supported OSes`, `Supported CPU Architecture`, `CUDA APIs involved`, `[CCCL CUB](https://nvidia.github.io/cccl/cub/)`

> **日本語**
> `cpp/4_CUDA_Libraries/cubDeviceTransform` は `4_CUDA_Libraries` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `cubDeviceTransform - CUB DeviceTransform N-to-M` and should be read together with the original README and source files.
