...
> **日本語**
> `cpp/7_libNVVM/device-side-launch` は `7_libNVVM` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `device-side-launch` and should be read together with the original README and source files.
