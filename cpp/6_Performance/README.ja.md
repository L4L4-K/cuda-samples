...
> **日本語**
> `cpp/6_Performance` は `6_Performance` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `6. Performance` and should be read together with the original README and source files.
