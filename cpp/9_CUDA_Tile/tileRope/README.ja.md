...
> **日本語**
> `cpp/9_CUDA_Tile/tileRope` は `9_CUDA_Tile` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `tileRope` and should be read together with the original README and source files.
