...
Original README headings: `9. CUDA Tile`, `[helloTile](./helloTile)`, `[tileVectorAdd](./tileVectorAdd)`, `[tileTranspose](./tileTranspose)`, `[tileMatmul](./tileMatmul)`, `[tileMatmulAutotuner](./tileMatmulAutotuner)`, `[tileBmm](./tileBmm)`, `[tileLayerNorm](./tileLayerNorm)`

> **日本語**
> `cpp/9_CUDA_Tile` は `9_CUDA_Tile` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `9. CUDA Tile` and should be read together with the original README and source files.
