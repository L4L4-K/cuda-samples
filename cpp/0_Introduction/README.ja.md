...
Original README headings: `0. Introduction`, `[asyncAPI](./asyncAPI)`, `[clock](./clock)`, `[clock_nvrtc](./clock_nvrtc)`, `[cudaOpenMP](./cudaOpenMP)`, `[fp16ScalarProduct](./fp16ScalarProduct)`, `[matrixMul](./matrixMul)`, `[matrixMul_nvrtc](./matrixMul_nvrtc)`

> **日本語**
> `cpp/0_Introduction` は `0_Introduction` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `0. Introduction` and should be read together with the original README and source files.
