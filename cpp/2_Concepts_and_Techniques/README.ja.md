...
Original README headings: `2. Concepts and Techniques`, `[boxFilter](./boxFilter)`, `[convolutionSeparable](./convolutionSeparable)`, `[convolutionTexture](./convolutionTexture)`, `[dct8x8](./dct8x8)`, `[EGLStream_CUDA_CrossGPU](./EGLStream_CUDA_CrossGPU)`, `[EGLStream_CUDA_Interop](./EGLStream_CUDA_Interop)`, `[eigenvalues](./eigenvalues)`

> **日本語**
> `cpp/2_Concepts_and_Techniques` は `2_Concepts_and_Techniques` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `2. Concepts and Techniques` and should be read together with the original README and source files.
