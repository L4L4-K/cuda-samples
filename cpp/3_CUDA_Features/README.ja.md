...
Original README headings: `3. CUDA Features`, `[bf16TensorCoreGemm](./bf16TensorCoreGemm)`, `[binaryPartitionCG](./binaryPartitionCG)`, `[bindlessTexture](./bindlessTexture)`, `[cdpAdvancedQuicksort](./cdpAdvancedQuicksort)`, `[cdpBezierTessellation](./cdpBezierTessellation)`, `[cdpQuadtree](./cdpQuadtree)`, `[cdpSimplePrint](./cdpSimplePrint)`

> **日本語**
> `cpp/3_CUDA_Features` は `3_CUDA_Features` に属する CUDA sample です。英語 README の目的と手順を残し、ここでは日本語で実装の読み方を補足します。
>
> **学習メモ**
...
English anchor: this sample demonstrates `3. CUDA Features` and should be read together with the original README and source files.
