...
- `marchingCubes.cpp`: focus on `cudaFree`, `CUDA`, `cudaMalloc`, `cudaMemcpy`, `cudaMemcpyDeviceToHost`.
- `marchingCubes_kernel.cu`: focus on `threadIdx`, `cudaTextureObject_t`, `blockIdx`, `cudaResourceDesc`, `cudaTextureDesc`.
