...
- `Mandelbrot.cpp`: focus on `CUDA`, `cudaMemcpy`, `cudaMalloc`, `cudaGraphicsResource`, `cudaGLMapBufferObject`.
- `Mandelbrot_cuda.cu`: focus on `blockDim`, `threadIdx`, `blockIdx`, `gridDim`, `CUDA`.
