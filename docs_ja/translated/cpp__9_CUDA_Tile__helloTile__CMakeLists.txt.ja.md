# cpp/9_CUDA_Tile/helloTile/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/9_CUDA_Tile/helloTile/CMakeLists.txt`](../../cpp/9_CUDA_Tile/helloTile/CMakeLists.txt)
