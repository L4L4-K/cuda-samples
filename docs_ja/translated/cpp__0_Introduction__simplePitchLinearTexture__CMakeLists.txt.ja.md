# cpp/0_Introduction/simplePitchLinearTexture/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simplePitchLinearTexture/CMakeLists.txt`](../../cpp/0_Introduction/simplePitchLinearTexture/CMakeLists.txt)
