# cpp/3_CUDA_Features/bindlessTexture/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/bindlessTexture/CMakeLists.txt`](../../cpp/3_CUDA_Features/bindlessTexture/CMakeLists.txt)
