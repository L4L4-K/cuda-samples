# cpp/0_Introduction/simpleCubemapTexture/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleCubemapTexture/CMakeLists.txt`](../../cpp/0_Introduction/simpleCubemapTexture/CMakeLists.txt)
