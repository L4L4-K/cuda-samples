# cpp/4_CUDA_Libraries/simpleCUFFT/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/simpleCUFFT/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/simpleCUFFT/CMakeLists.txt)
