# python/1_GettingStarted/systemInfo/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/systemInfo/requirements.txt`](../../python/1_GettingStarted/systemInfo/requirements.txt)
