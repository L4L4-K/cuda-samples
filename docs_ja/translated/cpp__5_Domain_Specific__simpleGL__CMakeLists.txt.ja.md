# cpp/5_Domain_Specific/simpleGL/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/simpleGL/CMakeLists.txt`](../../cpp/5_Domain_Specific/simpleGL/CMakeLists.txt)
