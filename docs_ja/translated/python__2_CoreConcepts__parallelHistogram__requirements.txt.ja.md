# python/2_CoreConcepts/parallelHistogram/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/parallelHistogram/requirements.txt`](../../python/2_CoreConcepts/parallelHistogram/requirements.txt)
...
Headings:
- `Parallel Histogram with Atomics Sample Requirements`
