# cpp/0_Introduction/UnifiedMemoryStreams/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/UnifiedMemoryStreams/CMakeLists.txt`](../../cpp/0_Introduction/UnifiedMemoryStreams/CMakeLists.txt)
