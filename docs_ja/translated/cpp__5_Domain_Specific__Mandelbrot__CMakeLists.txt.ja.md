# cpp/5_Domain_Specific/Mandelbrot/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/Mandelbrot/CMakeLists.txt`](../../cpp/5_Domain_Specific/Mandelbrot/CMakeLists.txt)
