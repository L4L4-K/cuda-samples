# cpp/0_Introduction/simpleTexture3D/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleTexture3D/CMakeLists.txt`](../../cpp/0_Introduction/simpleTexture3D/CMakeLists.txt)
