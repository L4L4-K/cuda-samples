# cpp/4_CUDA_Libraries/cubDeviceFind/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/cubDeviceFind/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/cubDeviceFind/CMakeLists.txt)
