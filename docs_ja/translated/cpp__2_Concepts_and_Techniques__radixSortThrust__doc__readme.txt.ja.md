# cpp/2_Concepts_and_Techniques/radixSortThrust/doc/readme.txt Japanese Companion

Original English/source document: [`cpp/2_Concepts_and_Techniques/radixSortThrust/doc/readme.txt`](../../cpp/2_Concepts_and_Techniques/radixSortThrust/doc/readme.txt)
...
- OVERVIEW
- --------
- This sample demonstrates a very fast and efficient parallel radix sort implemented in C for CUDA. The included RadixSort class can sort either key-value pairs (with float or unsign
- This radix sort code and the underlying algorithm is discussed in detail in the paper "Designing Efficient Sorting Algorithms for Manycore GPUs". A PDF version of this paper is ava
- -----
