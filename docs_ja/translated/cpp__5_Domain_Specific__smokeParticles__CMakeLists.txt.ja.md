# cpp/5_Domain_Specific/smokeParticles/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/smokeParticles/CMakeLists.txt`](../../cpp/5_Domain_Specific/smokeParticles/CMakeLists.txt)
