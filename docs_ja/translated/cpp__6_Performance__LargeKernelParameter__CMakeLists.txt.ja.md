# cpp/6_Performance/LargeKernelParameter/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/6_Performance/LargeKernelParameter/CMakeLists.txt`](../../cpp/6_Performance/LargeKernelParameter/CMakeLists.txt)
