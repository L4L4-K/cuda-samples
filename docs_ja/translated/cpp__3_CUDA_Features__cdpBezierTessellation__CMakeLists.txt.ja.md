# cpp/3_CUDA_Features/cdpBezierTessellation/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/cdpBezierTessellation/CMakeLists.txt`](../../cpp/3_CUDA_Features/cdpBezierTessellation/CMakeLists.txt)
