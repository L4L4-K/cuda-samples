# cpp/5_Domain_Specific/nbody/doc/nbody_gems3_ch31.pdf Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/nbody/doc/nbody_gems3_ch31.pdf`](../../cpp/5_Domain_Specific/nbody/doc/nbody_gems3_ch31.pdf)

Role: Supplemental technical document

## English Reference

Binary or office document: `cpp/5_Domain_Specific/nbody/doc/nbody_gems3_ch31.pdf`. The original file is preserved unchanged.
