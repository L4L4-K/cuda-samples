# cpp/0_Introduction/simpleLayeredTexture/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleLayeredTexture/CMakeLists.txt`](../../cpp/0_Introduction/simpleLayeredTexture/CMakeLists.txt)
