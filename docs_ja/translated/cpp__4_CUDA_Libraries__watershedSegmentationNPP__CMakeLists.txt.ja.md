# cpp/4_CUDA_Libraries/watershedSegmentationNPP/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/watershedSegmentationNPP/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/watershedSegmentationNPP/CMakeLists.txt)
