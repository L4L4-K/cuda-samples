# cpp/0_Introduction/simpleZeroCopy/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleZeroCopy/CMakeLists.txt`](../../cpp/0_Introduction/simpleZeroCopy/CMakeLists.txt)
