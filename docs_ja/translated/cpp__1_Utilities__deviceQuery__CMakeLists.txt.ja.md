# cpp/1_Utilities/deviceQuery/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/1_Utilities/deviceQuery/CMakeLists.txt`](../../cpp/1_Utilities/deviceQuery/CMakeLists.txt)
