# cpp/5_Domain_Specific/fluidsGL/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/fluidsGL/CMakeLists.txt`](../../cpp/5_Domain_Specific/fluidsGL/CMakeLists.txt)
