# cpp/8_Platform_Specific/Tegra/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/8_Platform_Specific/Tegra/CMakeLists.txt`](../../cpp/8_Platform_Specific/Tegra/CMakeLists.txt)
