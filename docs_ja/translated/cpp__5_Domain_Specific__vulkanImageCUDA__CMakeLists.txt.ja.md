# cpp/5_Domain_Specific/vulkanImageCUDA/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/vulkanImageCUDA/CMakeLists.txt`](../../cpp/5_Domain_Specific/vulkanImageCUDA/CMakeLists.txt)
