# cpp/5_Domain_Specific/p2pBandwidthLatencyTest/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/p2pBandwidthLatencyTest/CMakeLists.txt`](../../cpp/5_Domain_Specific/p2pBandwidthLatencyTest/CMakeLists.txt)
