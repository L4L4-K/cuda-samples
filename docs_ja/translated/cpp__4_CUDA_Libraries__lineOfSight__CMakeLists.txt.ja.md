# cpp/4_CUDA_Libraries/lineOfSight/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/lineOfSight/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/lineOfSight/CMakeLists.txt)
