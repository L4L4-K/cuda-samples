# cpp/5_Domain_Specific/SobelFilter/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/SobelFilter/CMakeLists.txt`](../../cpp/5_Domain_Specific/SobelFilter/CMakeLists.txt)
