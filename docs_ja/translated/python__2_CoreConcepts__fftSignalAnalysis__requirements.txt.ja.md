# python/2_CoreConcepts/fftSignalAnalysis/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/fftSignalAnalysis/requirements.txt`](../../python/2_CoreConcepts/fftSignalAnalysis/requirements.txt)
