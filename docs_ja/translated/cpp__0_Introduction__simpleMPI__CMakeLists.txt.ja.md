# cpp/0_Introduction/simpleMPI/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleMPI/CMakeLists.txt`](../../cpp/0_Introduction/simpleMPI/CMakeLists.txt)
