# cpp/5_Domain_Specific/nbody/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/nbody/CMakeLists.txt`](../../cpp/5_Domain_Specific/nbody/CMakeLists.txt)
