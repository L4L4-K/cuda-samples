# cpp/4_CUDA_Libraries/libcuxxRandom/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/libcuxxRandom/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/libcuxxRandom/CMakeLists.txt)
