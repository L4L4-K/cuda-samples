# python/1_GettingStarted/copyImageArraytoGPU/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/copyImageArraytoGPU/requirements.txt`](../../python/1_GettingStarted/copyImageArraytoGPU/requirements.txt)
...
Headings:
- `Image Array Copy to GPU Sample Requirements`
