# cpp/5_Domain_Specific/convolutionFFT2D/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/convolutionFFT2D/CMakeLists.txt`](../../cpp/5_Domain_Specific/convolutionFFT2D/CMakeLists.txt)
