# cpp/5_Domain_Specific/SobolQRNG/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/SobolQRNG/CMakeLists.txt`](../../cpp/5_Domain_Specific/SobolQRNG/CMakeLists.txt)
