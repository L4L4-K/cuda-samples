# cpp/4_CUDA_Libraries/conjugateGradientUM/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/conjugateGradientUM/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/conjugateGradientUM/CMakeLists.txt)
