# cpp/0_Introduction/simpleIPC/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleIPC/CMakeLists.txt`](../../cpp/0_Introduction/simpleIPC/CMakeLists.txt)
