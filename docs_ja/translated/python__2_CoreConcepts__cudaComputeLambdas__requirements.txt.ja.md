# python/2_CoreConcepts/cudaComputeLambdas/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/cudaComputeLambdas/requirements.txt`](../../python/2_CoreConcepts/cudaComputeLambdas/requirements.txt)
