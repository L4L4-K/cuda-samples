# cpp/4_CUDA_Libraries/simpleCUBLAS/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/simpleCUBLAS/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/simpleCUBLAS/CMakeLists.txt)
