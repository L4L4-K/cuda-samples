# cpp/7_libNVVM/device-side-launch/README.md Japanese Companion

Original English/source document: [`cpp/7_libNVVM/device-side-launch/README.md`](../../cpp/7_libNVVM/device-side-launch/README.md)
