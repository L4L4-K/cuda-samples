# python/1_GettingStarted/blurImageUnifiedMemory/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/blurImageUnifiedMemory/requirements.txt`](../../python/1_GettingStarted/blurImageUnifiedMemory/requirements.txt)
