# cpp/3_CUDA_Features/dmmaTensorCoreGemm/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/dmmaTensorCoreGemm/CMakeLists.txt`](../../cpp/3_CUDA_Features/dmmaTensorCoreGemm/CMakeLists.txt)
