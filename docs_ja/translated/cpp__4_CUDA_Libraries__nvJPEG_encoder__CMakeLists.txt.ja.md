# cpp/4_CUDA_Libraries/nvJPEG_encoder/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/nvJPEG_encoder/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/nvJPEG_encoder/CMakeLists.txt)
