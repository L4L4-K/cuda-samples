# python/4_DistributedComputing/simpleP2P/requirements.txt Japanese Companion

Original English/source document: [`python/4_DistributedComputing/simpleP2P/requirements.txt`](../../python/4_DistributedComputing/simpleP2P/requirements.txt)
