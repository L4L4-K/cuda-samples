# cpp/0_Introduction/simpleHyperQ/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleHyperQ/CMakeLists.txt`](../../cpp/0_Introduction/simpleHyperQ/CMakeLists.txt)
