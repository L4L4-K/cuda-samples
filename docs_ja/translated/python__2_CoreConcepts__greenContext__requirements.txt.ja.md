# python/2_CoreConcepts/greenContext/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/greenContext/requirements.txt`](../../python/2_CoreConcepts/greenContext/requirements.txt)
