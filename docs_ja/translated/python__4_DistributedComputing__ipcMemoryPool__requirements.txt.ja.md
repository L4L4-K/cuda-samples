# python/4_DistributedComputing/ipcMemoryPool/requirements.txt Japanese Companion

Original English/source document: [`python/4_DistributedComputing/ipcMemoryPool/requirements.txt`](../../python/4_DistributedComputing/ipcMemoryPool/requirements.txt)
