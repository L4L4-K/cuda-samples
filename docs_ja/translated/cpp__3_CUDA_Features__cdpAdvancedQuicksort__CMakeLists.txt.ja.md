# cpp/3_CUDA_Features/cdpAdvancedQuicksort/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/cdpAdvancedQuicksort/CMakeLists.txt`](../../cpp/3_CUDA_Features/cdpAdvancedQuicksort/CMakeLists.txt)
