# cpp/3_CUDA_Features/newdelete/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/newdelete/CMakeLists.txt`](../../cpp/3_CUDA_Features/newdelete/CMakeLists.txt)
