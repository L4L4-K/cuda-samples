# cpp/4_CUDA_Libraries/batchCUBLAS/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/batchCUBLAS/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/batchCUBLAS/CMakeLists.txt)
