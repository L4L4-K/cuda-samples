# cpp/6_Performance/UnifiedMemoryPerf/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/6_Performance/UnifiedMemoryPerf/CMakeLists.txt`](../../cpp/6_Performance/UnifiedMemoryPerf/CMakeLists.txt)
