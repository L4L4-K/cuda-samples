# python/2_CoreConcepts/blockwiseSum/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/blockwiseSum/requirements.txt`](../../python/2_CoreConcepts/blockwiseSum/requirements.txt)
