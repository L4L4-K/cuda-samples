# cpp/6_Performance/alignedTypes/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/6_Performance/alignedTypes/CMakeLists.txt`](../../cpp/6_Performance/alignedTypes/CMakeLists.txt)
