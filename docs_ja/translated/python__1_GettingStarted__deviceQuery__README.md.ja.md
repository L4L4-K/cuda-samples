# python/1_GettingStarted/deviceQuery/README.md Japanese Companion

Original English/source document: [`python/1_GettingStarted/deviceQuery/README.md`](../../python/1_GettingStarted/deviceQuery/README.md)
