# python/1_GettingStarted/vectorAdd/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/vectorAdd/requirements.txt`](../../python/1_GettingStarted/vectorAdd/requirements.txt)
