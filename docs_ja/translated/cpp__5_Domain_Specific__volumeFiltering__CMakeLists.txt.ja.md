# cpp/5_Domain_Specific/volumeFiltering/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/volumeFiltering/CMakeLists.txt`](../../cpp/5_Domain_Specific/volumeFiltering/CMakeLists.txt)
