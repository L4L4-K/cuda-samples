# cpp/0_Introduction/simpleSurfaceWrite/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleSurfaceWrite/CMakeLists.txt`](../../cpp/0_Introduction/simpleSurfaceWrite/CMakeLists.txt)
