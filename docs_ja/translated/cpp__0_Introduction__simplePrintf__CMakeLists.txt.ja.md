# cpp/0_Introduction/simplePrintf/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simplePrintf/CMakeLists.txt`](../../cpp/0_Introduction/simplePrintf/CMakeLists.txt)
