# cpp/4_CUDA_Libraries/nvJPEG/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/nvJPEG/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/nvJPEG/CMakeLists.txt)
