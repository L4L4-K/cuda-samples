# cpp/4_CUDA_Libraries/cubDeviceSegmentedScan/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/cubDeviceSegmentedScan/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/cubDeviceSegmentedScan/CMakeLists.txt)
