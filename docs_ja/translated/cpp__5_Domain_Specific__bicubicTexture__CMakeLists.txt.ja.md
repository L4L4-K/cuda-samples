# cpp/5_Domain_Specific/bicubicTexture/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/bicubicTexture/CMakeLists.txt`](../../cpp/5_Domain_Specific/bicubicTexture/CMakeLists.txt)
