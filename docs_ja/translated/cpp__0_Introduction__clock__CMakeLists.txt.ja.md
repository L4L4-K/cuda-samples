# cpp/0_Introduction/clock/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/clock/CMakeLists.txt`](../../cpp/0_Introduction/clock/CMakeLists.txt)
