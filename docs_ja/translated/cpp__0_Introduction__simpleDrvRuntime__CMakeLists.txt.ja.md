# cpp/0_Introduction/simpleDrvRuntime/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleDrvRuntime/CMakeLists.txt`](../../cpp/0_Introduction/simpleDrvRuntime/CMakeLists.txt)
