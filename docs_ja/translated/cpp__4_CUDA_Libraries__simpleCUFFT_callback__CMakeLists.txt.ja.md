# cpp/4_CUDA_Libraries/simpleCUFFT_callback/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/simpleCUFFT_callback/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/simpleCUFFT_callback/CMakeLists.txt)
