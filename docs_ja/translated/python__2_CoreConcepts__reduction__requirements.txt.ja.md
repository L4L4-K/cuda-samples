# python/2_CoreConcepts/reduction/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/reduction/requirements.txt`](../../python/2_CoreConcepts/reduction/requirements.txt)
...
Headings:
- `Python CUDA Reduction Sample Requirements`
