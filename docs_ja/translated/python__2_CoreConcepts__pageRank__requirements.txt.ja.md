# python/2_CoreConcepts/pageRank/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/pageRank/requirements.txt`](../../python/2_CoreConcepts/pageRank/requirements.txt)
