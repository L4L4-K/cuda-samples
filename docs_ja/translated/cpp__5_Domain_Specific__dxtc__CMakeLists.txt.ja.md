# cpp/5_Domain_Specific/dxtc/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/dxtc/CMakeLists.txt`](../../cpp/5_Domain_Specific/dxtc/CMakeLists.txt)
