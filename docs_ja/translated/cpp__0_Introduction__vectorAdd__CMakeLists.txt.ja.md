# cpp/0_Introduction/vectorAdd/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/vectorAdd/CMakeLists.txt`](../../cpp/0_Introduction/vectorAdd/CMakeLists.txt)
