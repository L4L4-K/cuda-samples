# cpp/2_Concepts_and_Techniques/histogram/doc/histogram.pdf Japanese Companion

Original English/source document: [`cpp/2_Concepts_and_Techniques/histogram/doc/histogram.pdf`](../../cpp/2_Concepts_and_Techniques/histogram/doc/histogram.pdf)

Role: Supplemental technical document

## English Reference

Binary or office document: `cpp/2_Concepts_and_Techniques/histogram/doc/histogram.pdf`. The original file is preserved unchanged.
