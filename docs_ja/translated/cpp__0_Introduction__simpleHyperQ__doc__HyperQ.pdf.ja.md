# cpp/0_Introduction/simpleHyperQ/doc/HyperQ.pdf Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleHyperQ/doc/HyperQ.pdf`](../../cpp/0_Introduction/simpleHyperQ/doc/HyperQ.pdf)

Role: Supplemental technical document

## English Reference

Binary or office document: `cpp/0_Introduction/simpleHyperQ/doc/HyperQ.pdf`. The original file is preserved unchanged.
