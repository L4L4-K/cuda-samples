# python/2_CoreConcepts/simpleZeroCopy/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/simpleZeroCopy/requirements.txt`](../../python/2_CoreConcepts/simpleZeroCopy/requirements.txt)
