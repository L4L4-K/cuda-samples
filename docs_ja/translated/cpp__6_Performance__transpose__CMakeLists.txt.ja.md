# cpp/6_Performance/transpose/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/6_Performance/transpose/CMakeLists.txt`](../../cpp/6_Performance/transpose/CMakeLists.txt)
