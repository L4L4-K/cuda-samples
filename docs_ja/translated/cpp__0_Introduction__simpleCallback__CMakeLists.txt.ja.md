# cpp/0_Introduction/simpleCallback/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleCallback/CMakeLists.txt`](../../cpp/0_Introduction/simpleCallback/CMakeLists.txt)
