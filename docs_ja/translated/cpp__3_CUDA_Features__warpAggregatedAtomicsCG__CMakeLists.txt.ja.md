# cpp/3_CUDA_Features/warpAggregatedAtomicsCG/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/warpAggregatedAtomicsCG/CMakeLists.txt`](../../cpp/3_CUDA_Features/warpAggregatedAtomicsCG/CMakeLists.txt)
