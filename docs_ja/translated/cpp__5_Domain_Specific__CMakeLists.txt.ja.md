# cpp/5_Domain_Specific/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/CMakeLists.txt`](../../cpp/5_Domain_Specific/CMakeLists.txt)
