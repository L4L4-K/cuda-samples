# cpp/5_Domain_Specific/MonteCarloMultiGPU/doc/MonteCarlo.pdf Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/MonteCarloMultiGPU/doc/MonteCarlo.pdf`](../../cpp/5_Domain_Specific/MonteCarloMultiGPU/doc/MonteCarlo.pdf)

Role: Supplemental technical document

## English Reference

Binary or office document: `cpp/5_Domain_Specific/MonteCarloMultiGPU/doc/MonteCarlo.pdf`. The original file is preserved unchanged.
