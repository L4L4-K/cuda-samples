# cpp/4_CUDA_Libraries/oceanFFT/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/oceanFFT/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/oceanFFT/CMakeLists.txt)
