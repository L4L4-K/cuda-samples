# python/1_GettingStarted/numpyVsCupy/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/numpyVsCupy/requirements.txt`](../../python/1_GettingStarted/numpyVsCupy/requirements.txt)
