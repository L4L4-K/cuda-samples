# cpp/0_Introduction/simpleAssert_nvrtc/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleAssert_nvrtc/CMakeLists.txt`](../../cpp/0_Introduction/simpleAssert_nvrtc/CMakeLists.txt)
