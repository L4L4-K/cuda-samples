# cpp/1_Utilities/deviceQueryDrv/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/1_Utilities/deviceQueryDrv/CMakeLists.txt`](../../cpp/1_Utilities/deviceQueryDrv/CMakeLists.txt)
