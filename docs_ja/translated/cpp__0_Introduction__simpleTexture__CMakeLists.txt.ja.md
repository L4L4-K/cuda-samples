# cpp/0_Introduction/simpleTexture/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleTexture/CMakeLists.txt`](../../cpp/0_Introduction/simpleTexture/CMakeLists.txt)
