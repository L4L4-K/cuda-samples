# python/2_CoreConcepts/memoryResources/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/memoryResources/requirements.txt`](../../python/2_CoreConcepts/memoryResources/requirements.txt)
