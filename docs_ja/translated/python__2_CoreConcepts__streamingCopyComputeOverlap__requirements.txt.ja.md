# python/2_CoreConcepts/streamingCopyComputeOverlap/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/streamingCopyComputeOverlap/requirements.txt`](../../python/2_CoreConcepts/streamingCopyComputeOverlap/requirements.txt)
...
Headings:
- `Streaming Copy Compute Overlap Sample Requirements`
