# cpp/3_CUDA_Features/cudaTensorCoreGemm/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/cudaTensorCoreGemm/CMakeLists.txt`](../../cpp/3_CUDA_Features/cudaTensorCoreGemm/CMakeLists.txt)
