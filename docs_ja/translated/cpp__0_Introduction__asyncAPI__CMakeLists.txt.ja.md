# cpp/0_Introduction/asyncAPI/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/asyncAPI/CMakeLists.txt`](../../cpp/0_Introduction/asyncAPI/CMakeLists.txt)
