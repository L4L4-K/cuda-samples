# cpp/9_CUDA_Tile/tileTranspose/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/9_CUDA_Tile/tileTranspose/CMakeLists.txt`](../../cpp/9_CUDA_Tile/tileTranspose/CMakeLists.txt)
