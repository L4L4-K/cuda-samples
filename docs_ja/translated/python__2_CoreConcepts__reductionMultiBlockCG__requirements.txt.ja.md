# python/2_CoreConcepts/reductionMultiBlockCG/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/reductionMultiBlockCG/requirements.txt`](../../python/2_CoreConcepts/reductionMultiBlockCG/requirements.txt)
