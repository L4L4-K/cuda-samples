# cpp/4_CUDA_Libraries/boxFilterNPP/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/boxFilterNPP/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/boxFilterNPP/CMakeLists.txt)
