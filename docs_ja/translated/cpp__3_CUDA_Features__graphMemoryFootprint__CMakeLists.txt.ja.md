# cpp/3_CUDA_Features/graphMemoryFootprint/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/graphMemoryFootprint/CMakeLists.txt`](../../cpp/3_CUDA_Features/graphMemoryFootprint/CMakeLists.txt)
