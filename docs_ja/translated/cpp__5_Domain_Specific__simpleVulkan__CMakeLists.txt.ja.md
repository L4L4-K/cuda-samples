# cpp/5_Domain_Specific/simpleVulkan/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/simpleVulkan/CMakeLists.txt`](../../cpp/5_Domain_Specific/simpleVulkan/CMakeLists.txt)
