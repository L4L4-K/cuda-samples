# python/2_CoreConcepts/parallelReduction/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/parallelReduction/requirements.txt`](../../python/2_CoreConcepts/parallelReduction/requirements.txt)
