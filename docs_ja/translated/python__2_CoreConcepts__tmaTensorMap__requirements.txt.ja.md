# python/2_CoreConcepts/tmaTensorMap/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/tmaTensorMap/requirements.txt`](../../python/2_CoreConcepts/tmaTensorMap/requirements.txt)
