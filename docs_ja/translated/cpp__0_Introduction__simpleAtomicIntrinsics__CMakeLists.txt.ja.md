# cpp/0_Introduction/simpleAtomicIntrinsics/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleAtomicIntrinsics/CMakeLists.txt`](../../cpp/0_Introduction/simpleAtomicIntrinsics/CMakeLists.txt)
