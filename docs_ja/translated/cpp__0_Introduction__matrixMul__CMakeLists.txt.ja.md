# cpp/0_Introduction/matrixMul/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/matrixMul/CMakeLists.txt`](../../cpp/0_Introduction/matrixMul/CMakeLists.txt)
