# cpp/4_CUDA_Libraries/simpleCUFFT_2d_MGPU/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/simpleCUFFT_2d_MGPU/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/simpleCUFFT_2d_MGPU/CMakeLists.txt)
