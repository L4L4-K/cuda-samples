# cpp/4_CUDA_Libraries/conjugateGradient/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/conjugateGradient/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/conjugateGradient/CMakeLists.txt)
