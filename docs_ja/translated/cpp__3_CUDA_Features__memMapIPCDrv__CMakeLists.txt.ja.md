# cpp/3_CUDA_Features/memMapIPCDrv/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/memMapIPCDrv/CMakeLists.txt`](../../cpp/3_CUDA_Features/memMapIPCDrv/CMakeLists.txt)
