# cpp/3_CUDA_Features/immaTensorCoreGemm/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/immaTensorCoreGemm/CMakeLists.txt`](../../cpp/3_CUDA_Features/immaTensorCoreGemm/CMakeLists.txt)
