# cpp/4_CUDA_Libraries/simpleCUBLAS_LU/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/simpleCUBLAS_LU/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/simpleCUBLAS_LU/CMakeLists.txt)
