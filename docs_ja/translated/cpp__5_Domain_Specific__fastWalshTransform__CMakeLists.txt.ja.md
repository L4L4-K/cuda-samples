# cpp/5_Domain_Specific/fastWalshTransform/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/fastWalshTransform/CMakeLists.txt`](../../cpp/5_Domain_Specific/fastWalshTransform/CMakeLists.txt)
