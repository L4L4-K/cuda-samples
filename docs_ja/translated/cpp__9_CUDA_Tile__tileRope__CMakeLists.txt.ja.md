# cpp/9_CUDA_Tile/tileRope/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/9_CUDA_Tile/tileRope/CMakeLists.txt`](../../cpp/9_CUDA_Tile/tileRope/CMakeLists.txt)
