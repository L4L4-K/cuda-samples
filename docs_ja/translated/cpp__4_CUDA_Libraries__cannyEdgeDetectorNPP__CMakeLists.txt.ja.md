# cpp/4_CUDA_Libraries/cannyEdgeDetectorNPP/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/cannyEdgeDetectorNPP/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/cannyEdgeDetectorNPP/CMakeLists.txt)
