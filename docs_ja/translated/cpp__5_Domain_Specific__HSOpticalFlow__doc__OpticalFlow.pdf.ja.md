# cpp/5_Domain_Specific/HSOpticalFlow/doc/OpticalFlow.pdf Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/HSOpticalFlow/doc/OpticalFlow.pdf`](../../cpp/5_Domain_Specific/HSOpticalFlow/doc/OpticalFlow.pdf)

Role: Supplemental technical document

## English Reference

Binary or office document: `cpp/5_Domain_Specific/HSOpticalFlow/doc/OpticalFlow.pdf`. The original file is preserved unchanged.
