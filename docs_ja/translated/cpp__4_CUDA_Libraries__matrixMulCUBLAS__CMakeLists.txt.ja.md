# cpp/4_CUDA_Libraries/matrixMulCUBLAS/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/matrixMulCUBLAS/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/matrixMulCUBLAS/CMakeLists.txt)
