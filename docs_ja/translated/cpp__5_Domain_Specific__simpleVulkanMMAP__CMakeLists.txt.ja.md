# cpp/5_Domain_Specific/simpleVulkanMMAP/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/simpleVulkanMMAP/CMakeLists.txt`](../../cpp/5_Domain_Specific/simpleVulkanMMAP/CMakeLists.txt)
