# python/1_GettingStarted/kernelNsysProfile/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/kernelNsysProfile/requirements.txt`](../../python/1_GettingStarted/kernelNsysProfile/requirements.txt)
...
Headings:
- `Nsight System Kernels Profiling Sample - Requirements`
