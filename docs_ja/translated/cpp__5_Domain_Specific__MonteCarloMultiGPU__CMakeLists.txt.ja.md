# cpp/5_Domain_Specific/MonteCarloMultiGPU/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/MonteCarloMultiGPU/CMakeLists.txt`](../../cpp/5_Domain_Specific/MonteCarloMultiGPU/CMakeLists.txt)
