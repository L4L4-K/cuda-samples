# cpp/3_CUDA_Features/globalToShmemAsyncCopy/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/globalToShmemAsyncCopy/CMakeLists.txt`](../../cpp/3_CUDA_Features/globalToShmemAsyncCopy/CMakeLists.txt)
