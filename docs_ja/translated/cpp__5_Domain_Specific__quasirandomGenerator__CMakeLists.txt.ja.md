# cpp/5_Domain_Specific/quasirandomGenerator/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/quasirandomGenerator/CMakeLists.txt`](../../cpp/5_Domain_Specific/quasirandomGenerator/CMakeLists.txt)
