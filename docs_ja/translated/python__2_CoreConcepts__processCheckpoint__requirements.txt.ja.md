# python/2_CoreConcepts/processCheckpoint/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/processCheckpoint/requirements.txt`](../../python/2_CoreConcepts/processCheckpoint/requirements.txt)
