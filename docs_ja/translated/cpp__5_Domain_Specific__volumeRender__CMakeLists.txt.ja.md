# cpp/5_Domain_Specific/volumeRender/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/5_Domain_Specific/volumeRender/CMakeLists.txt`](../../cpp/5_Domain_Specific/volumeRender/CMakeLists.txt)
