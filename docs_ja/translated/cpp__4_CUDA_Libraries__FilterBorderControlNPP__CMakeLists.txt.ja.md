# cpp/4_CUDA_Libraries/FilterBorderControlNPP/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/FilterBorderControlNPP/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/FilterBorderControlNPP/CMakeLists.txt)
