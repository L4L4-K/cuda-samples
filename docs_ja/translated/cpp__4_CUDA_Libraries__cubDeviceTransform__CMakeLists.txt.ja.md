# cpp/4_CUDA_Libraries/cubDeviceTransform/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/cubDeviceTransform/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/cubDeviceTransform/CMakeLists.txt)
