# cpp/3_CUDA_Features/binaryPartitionCG/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/binaryPartitionCG/CMakeLists.txt`](../../cpp/3_CUDA_Features/binaryPartitionCG/CMakeLists.txt)
