# cpp/4_CUDA_Libraries/libcuxxMdspan/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/libcuxxMdspan/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/libcuxxMdspan/CMakeLists.txt)
