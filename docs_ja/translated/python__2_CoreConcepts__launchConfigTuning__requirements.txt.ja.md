# python/2_CoreConcepts/launchConfigTuning/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/launchConfigTuning/requirements.txt`](../../python/2_CoreConcepts/launchConfigTuning/requirements.txt)
...
Headings:
- `Launch Configuration Tuning Sample Requirements`
