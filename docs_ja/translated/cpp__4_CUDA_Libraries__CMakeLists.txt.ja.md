# cpp/4_CUDA_Libraries/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/CMakeLists.txt)
