# python/3_FrameworkInterop/customTensorFlowKernel/requirements.txt Japanese Companion

Original English/source document: [`python/3_FrameworkInterop/customTensorFlowKernel/requirements.txt`](../../python/3_FrameworkInterop/customTensorFlowKernel/requirements.txt)
