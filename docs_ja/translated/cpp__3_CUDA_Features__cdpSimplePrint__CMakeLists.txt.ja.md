# cpp/3_CUDA_Features/cdpSimplePrint/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/cdpSimplePrint/CMakeLists.txt`](../../cpp/3_CUDA_Features/cdpSimplePrint/CMakeLists.txt)
