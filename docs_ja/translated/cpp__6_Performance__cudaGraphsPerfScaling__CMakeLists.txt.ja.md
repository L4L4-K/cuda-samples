# cpp/6_Performance/cudaGraphsPerfScaling/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/6_Performance/cudaGraphsPerfScaling/CMakeLists.txt`](../../cpp/6_Performance/cudaGraphsPerfScaling/CMakeLists.txt)
