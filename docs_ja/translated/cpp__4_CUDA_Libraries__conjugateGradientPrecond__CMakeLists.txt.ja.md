# cpp/4_CUDA_Libraries/conjugateGradientPrecond/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/4_CUDA_Libraries/conjugateGradientPrecond/CMakeLists.txt`](../../cpp/4_CUDA_Libraries/conjugateGradientPrecond/CMakeLists.txt)
