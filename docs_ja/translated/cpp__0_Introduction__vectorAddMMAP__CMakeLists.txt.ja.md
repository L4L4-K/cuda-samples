# cpp/0_Introduction/vectorAddMMAP/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/vectorAddMMAP/CMakeLists.txt`](../../cpp/0_Introduction/vectorAddMMAP/CMakeLists.txt)
