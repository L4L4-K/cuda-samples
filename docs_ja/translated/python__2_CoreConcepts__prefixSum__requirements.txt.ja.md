# python/2_CoreConcepts/prefixSum/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/prefixSum/requirements.txt`](../../python/2_CoreConcepts/prefixSum/requirements.txt)
...
Headings:
- `Prefix Sum Sample Requirements`
