# python/1_GettingStarted/simplePrint/requirements.txt Japanese Companion

Original English/source document: [`python/1_GettingStarted/simplePrint/requirements.txt`](../../python/1_GettingStarted/simplePrint/requirements.txt)
