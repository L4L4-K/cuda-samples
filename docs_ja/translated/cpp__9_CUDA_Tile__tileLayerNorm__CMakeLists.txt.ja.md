# cpp/9_CUDA_Tile/tileLayerNorm/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/9_CUDA_Tile/tileLayerNorm/CMakeLists.txt`](../../cpp/9_CUDA_Tile/tileLayerNorm/CMakeLists.txt)
