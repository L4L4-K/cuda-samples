# cpp/3_CUDA_Features/tf32TensorCoreGemm/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/3_CUDA_Features/tf32TensorCoreGemm/CMakeLists.txt`](../../cpp/3_CUDA_Features/tf32TensorCoreGemm/CMakeLists.txt)
