# python/2_CoreConcepts/binarySearch/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/binarySearch/requirements.txt`](../../python/2_CoreConcepts/binarySearch/requirements.txt)
