# python/2_CoreConcepts/cudaGraphs/requirements.txt Japanese Companion

Original English/source document: [`python/2_CoreConcepts/cudaGraphs/requirements.txt`](../../python/2_CoreConcepts/cudaGraphs/requirements.txt)
