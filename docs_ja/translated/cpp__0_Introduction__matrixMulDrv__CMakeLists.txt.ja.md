# cpp/0_Introduction/matrixMulDrv/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/matrixMulDrv/CMakeLists.txt`](../../cpp/0_Introduction/matrixMulDrv/CMakeLists.txt)
