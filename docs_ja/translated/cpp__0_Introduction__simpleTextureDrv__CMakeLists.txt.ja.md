# cpp/0_Introduction/simpleTextureDrv/CMakeLists.txt Japanese Companion

Original English/source document: [`cpp/0_Introduction/simpleTextureDrv/CMakeLists.txt`](../../cpp/0_Introduction/simpleTextureDrv/CMakeLists.txt)
